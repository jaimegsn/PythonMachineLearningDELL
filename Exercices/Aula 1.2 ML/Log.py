...
"""
print("Quantidade de Erros Ocorridos : " +
      str(len(re.findall(r'\d{2}:\d{2}:\d{2}\W\d{3} \W ERROR', log))))

print("Horario dos Erros :" +
      str(re.findall(r'\d{2}:\d{2}:\d{2}\W\d{3} \W ERROR', log)))
